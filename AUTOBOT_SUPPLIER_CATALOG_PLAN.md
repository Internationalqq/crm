...
## 21 сентября: кабели и знаки по уточнению пользователя

В [перечень потребностей](AUTOBOT_VOLGA_NEEDS.md) явно вынесены все семь марок кабеля и временные дорожные знаки/опоры/крепления из п. 8.1.10 договора. Объект — Рыбинск. Для знаков пока неизвестны количество и типы; они не превращены в выдуманные строки сметы.

[Пакет кабелей и знаков](AUTOBOT_CABLES_SIGNS_2026-09-21.md): +1 611 записей, в том числе 1 603 варианта Мегаполис, 300 сохранённых документов. ВВГ и медная F/UTP дали два новых подтверждения; результат после переноса и повтора на копии — 28/213 (13,1%), все исходные 26 сохранены. 1 576 опубликованных вариантов знаков не считаются дополнительным покрытием «Волги». Исходная смета и 843 задания сохранены. Подробные ограничения источников, проверки, резерв и состояние выпуска — в отчёте пакета.

Пакет опубликован: AutoBot `beafe8e5`, в рабочей базе подтверждены те же 28/213. Перенос, повтор, история и фильтры проверены после перезапуска; старые 38 317 записей сохранены. Следующий пакет: N001–N013 из согласованного реестра — нерудные материалы, бетон/смеси, плитка и бордюры. Он остаётся нужен: новая база знаков не заменяет остальные группы. Требования к источникам и порядок пакетов ниже сохраняются.

## Предыдущий шаг: список потребностей до выбора сайтов
