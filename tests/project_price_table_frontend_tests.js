...
assert.match(planningJs, /var counterpartyPriceLabel = isWork \? [^;]+;/);
assert.match(planningJs, /<th>' \+ counterpartyPriceLabel \+ '<\/th>/);
...
assert.match(planningJs, /var columnCount = canEdit \? 7 : 6;/);
assert.match(planningJs, /colspan="' \+ columnCount \+ '"/);
