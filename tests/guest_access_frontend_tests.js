...
assert.match(baseHtml, /router\.js\?v=[^"\s]*credential-guest-22/);
assert.match(routerJs, /app: '[^'\s]*credential-guest-22[^'\s]*'/);
assert.match(routerJs, /operations: '[^'\s]*credential-guest-22[^'\s]*'/);
assert.match(loginHtml, /app\.js\?v=[^"\s]*credential-guest-22/);
...
assert.match(loginHtml, /app\.css\?v=[^"\s]*credential-guest-22/);
