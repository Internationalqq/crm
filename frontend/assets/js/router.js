(function () {
    ...
    var SCRIPT_URLS = {
        ...
        planning: '/assets/js/planning.js?v=20260903-public-portfolio-1-production-print-scale-live-2-schedule-health-1-production-scroll-wheel-fix-1-production-print-pdf-2-production-print-scale-1-production-sections-1-production-full-edit-1',
